...
def load_model_from_checkpoint(
    ...
    """Load a model from checkpoint with automatic backbone detection if needed."""
    ...
    if model_name == 'auto':
        ...
        print(f"Using backbone: {backbone} (auto-detected from checkpoint)")
    else:
        backbone = model_name
        detected = detect_backbone_from_checkpoint(state_dict)
        print(f"Using backbone: {backbone} (checkpoint suggests: {detected})")
